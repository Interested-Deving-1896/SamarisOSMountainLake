#[derive(Clone, Debug)]
pub struct SystemReserveSnapshot {
    pub min_workers: u32,
...
impl SystemReserve {
    ...
    pub fn snapshot(&self) -> SystemReserveSnapshot {
        SystemReserveSnapshot {
...
mod tests {
    ...
    #[test]
    fn test_new() {
        let r = SystemReserve::new(3);
        assert_eq!(r.min_workers, 3);
        assert_eq!(r.current_reserved, 0);
    }

    #[test]
    fn test_reserve_and_release() {
        let mut r = SystemReserve::new(3);
        r.reserve(2);
        assert_eq!(r.current_reserved, 2);
        assert!(r.is_active());
        r.release(1);
    ...
    fn test_snapshot() {
        ...
        assert_eq!(s.current_reserved, 2);
        assert!(s.active);
    }
}
